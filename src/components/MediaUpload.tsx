...
export const MediaUpload = ({
  ...
  return <div className="space-y-4 md:space-y-8 animate-fade-in">
      ...
      <div className="flex gap-3 justify-center">
        <Button onClick={() => openCamera('photo')} disabled={isAnalyzing} className="h-14 w-14 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
          <Camera className="h-6 w-6" />
        </Button>
        
        <Button onClick={() => openCamera('video')} disabled={isAnalyzing} className="h-14 w-14 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
          <Video className="h-6 w-6" />
        </Button>

        <Button onClick={() => fileInputRef.current?.click()} disabled={isAnalyzing} className="h-14 w-14 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0">
